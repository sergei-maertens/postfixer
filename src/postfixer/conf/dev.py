...
os.environ.setdefault('SECRET_KEY', '@#^@cohoj8&f3-jyr^85@k%!hb*4y+bb49@x!bp8v9i6lndd==')

# uses postgresql by default, see base.py
os.environ.setdefault('DB_NAME', 'postfixer'),
os.environ.setdefault('DB_USER', 'postfixer'),
os.environ.setdefault('DB_PASSWORD', 'postfixer'),
